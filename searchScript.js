...
var svi_kristali= ["silma/Kristali za masazu i veliki obluci/dzambo kristali (Medium).jpg",
...
"silma/figure/angelit kugla (Medium).jpg",
...
"silma/sirovi kristali/ahat ploce (Medium).jpg",
...
"silma/Kristali za text Silmarilion/ahat beli (Medium).jpg",
...
var svi_kristali_text = ["dzambo kristali",
"dzambo kristali1",
"joni jaja zad zeleni aventurin",
"roleri za masazu",
"roze kvarc joni jaja",
"roze kvarc pecurke",
"angelit kugla","angelit piramide","dzambo kristali",
...
"ahat ploce","ahat sivi geode","amazonit","amazonit",
...
"ahat beli","ahat dendritski", "ahat mahovina","ahat roze",
...
function search(){
  ...
  var search_text = document.querySelector('#search_id').value;
  var rez = document.getElementById("rez_met");
  var search_text_up=search_text.toUpperCase();
  var brojac = 0;

  if (search_text !== "") {
    for (i = 0; i < svi_kristali_text.length; i++) {
      if(svi_kristali_text[i].toUpperCase().search(search_text_up)!=-1){

        var div = document.createElement('div');
        var img = document.createElement('img');
        var p = document.createElement('p');

        img.src = svi_kristali[i];
        p.innerHTML = svi_kristali_text[i];  
